...
The summary below shows the vscode run — the flagship large repo, served through the graph daemon — comparing the empty-MCP baseline against `@ttsc/graph` and `codegraph` across Claude Sonnet, Opus, and GPT-5.5. The full dashboard covers excalidraw, typeorm, vue, rxjs, zod, nestjs, and shopping-backend as well.
