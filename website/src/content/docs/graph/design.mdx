...
<Tabs
  items={[
    ...
    <code key="annotation">ITtscGraphAnnotation.ts</code>,
...
>
  ...
  <Tabs.Tab>
    <TtscWebsiteLocalSource
      path="packages/graph/src/structures/ITtscGraphAnnotation.ts"
      showLineNumbers
    />
  </Tabs.Tab>
  <Tabs.Tab>
