 ...
 * bridges are `low`. It is a separate axis so a framework pass can still mark
 * an especially certain derivation `high`, or downgrade an ambiguous one,
 * without changing how it was derived.
 */
